...
3. 有50个红球和50个白球，放进两个盒子，然后随机选择一个盒子随机摸一个球，怎么放取出红球的概率最大？
   ...
   // for a given ellipsoid : x^2 / a^2 + y^2 / b^2 + z^2 / c^2 = 1, find the volume of the largest cuboid in this ellipsoid
   
   给一个椭球 求最大内接长方体的体积。
   
   设长方体一个顶点是(x,y,z)，确定一个点时，其他点也确定，且V=8xyz,则题意是求一个条件极值，利用拉格朗日乘数法，当x=a/根号3， y = b/根号3 ， z = c/根号3，有最大体积。
   ...
   然后利用集合映射，得出锐角三角形概率是1/4 钝角三角形概率是3/4
